...
#--------------------------------------
#t-test paired durchfÃ¼hren: nicht auf den means, sondern auf den gecleanten daten
#--------------------------------------------
...
#for-loop: ttest-paired durchfÃ¼hren Ã¼ber alle Gene zwischen normal und tumor tissue
