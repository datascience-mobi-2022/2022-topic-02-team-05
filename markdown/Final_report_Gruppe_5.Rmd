...
layer contains as much neurons as features are given for each sample.
The number of neurons in each hidden layer and the number of hidden
layers vary and must be tested to give best results. The activation of
...
index. Pathways with a Jaccard index greater than a set threshold were
discarded.
