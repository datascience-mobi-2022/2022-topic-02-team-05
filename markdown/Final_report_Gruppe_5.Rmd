...
distinct expression patterns for each histological subype would be
...
example, only some THCAs subtypes experiance integrin alpha6beta4 driven
carcinogenis which might provide a viable target for thearpy. Integrins
