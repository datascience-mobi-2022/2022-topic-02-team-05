...
The biotype of the genes from the selected metabolic pathways, of the genes of the hallmark pathways and of the genes of the gene expression matrix was determined. Only genes with the same biotypes were kept. The hallmark pathways and the selected metabolic pathways were almost all protein-coding, so only the protein-coding genes of the expression matrices were maintained. 

```{r showbiotypeshallmarks, echo=FALSE, eval=TRUE, out.width = '20%', fig.align = "center", fig.cap="**Biotypes of Hallamrk genes**"}

knitr::include_graphics("tcga_exp_biotypes.png")#xxx
