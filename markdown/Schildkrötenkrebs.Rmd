...
```{r showheatmapaftercleaningmetabolic, echo=FALSE, eval=TRUE, out.width='65%', fig.align='center', fig.cap="Jaccard index of metabolic pathways against each other after cleaning"}
