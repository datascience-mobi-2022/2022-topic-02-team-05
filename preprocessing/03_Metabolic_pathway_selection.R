#-----------------------------
#Hier nehmen wir alle kanonischen pathways von msigdbr und überprüfen diese auf Kompatibilität mit unseren Daten
#Sollten pathways zu 90% in unseren gecleanten Genen enthalten sein, werden sie weiter verwendet
#-----------------------------
...
#Neuformatierung in die Form der hallmarkpathways 
...
#----------------------------
#Vergleichen wie viel Prozent der Gene in diesen kanonischen Pathways letzendlich in den gecleanten
#TCGA Genen enthalten sind
#----------------------------
...
#Die Heatmap zeigt, dass einige Pathways sich überschneiden
#um diese doppelten Pathways zu entfernen vergleichen wir, wie hoch die Summe aller
#Jaccardindices eines pathays ist (je höher desto mehr Ähnlichkeit)
...
#Heatmap mit der Summe aller jaccard indices
...
#-------------------------------------------
#Die Pathways werden mit den Hallmark pathways abgegelichen um dort Dopplung zu vermeiden.
#Dazu benutzen wir wieder den Jaccard index
#-------------------------------------------
...
#plotten der Ähnlichkeit der pathways
similarity = apply(hallm.jaccard, 1 , sum)
hist(similarity, breaks = 100)

#Die pathways werden behalten, deren Aehnlichkeit nicht groeßer als der 1s Berrecih ist
